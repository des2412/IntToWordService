...
public class TestConversionDelegateUk {
	...
	public void testNull() throws AppConversionException {
		conversionDelg.convertIntToWord(null, null);

	}

	@Test(expected = NullPointerException.class)
	public void testNonInt() throws AppConversionException {
		conversionDelg.convertIntToWord(Integer.MAX_VALUE + 1, ProvLang.UK);
	}

	@Test
	public void test12123113() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(12123113, ProvLang.UK);
		assertEquals(
	...
	public final void testZero() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(0, ProvLang.UK);
	...
	public final void test1() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(1, ProvLang.UK);
		assertNotNull("null unexpected", s);
		assertEquals("one", s);
	}
	...
	public final void test15() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(15, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(100, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test101() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(101, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test123() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(123, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test123456() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(123456, ProvLang.UK);
		assertNotNull("null unexpected", s);
		assertEquals(
	...
	public final void test1000000() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(1000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1000() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(1000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(10000, ProvLang.UK);
		assertNotNull("null UNexpected", s);
	...
	public final void test10099() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(10099, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10090() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(10090, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10001() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(10001, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000000() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(10000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000001() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(10000001, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100000() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(100000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100000000() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(100000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1100000() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(1100000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1123456() throws AppConversionException {
		String s = conversionDelg.convertIntToWord(1123456, ProvLang.UK);
		assertNotNull("null unexpected", s);

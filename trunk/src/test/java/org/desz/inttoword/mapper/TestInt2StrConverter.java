...
public class TestInt2StrConverter {
	...
	public void testNull() {
		converterService.convertIntToWord(null, null);

	}

	@Test(expected = NullPointerException.class)
	public void testNonInt() {
		converterService.convertIntToWord(Integer.MAX_VALUE + 1, ProvLang.UK);
	}

	@Test
	public void test12123113() {
		String s = converterService.convertIntToWord(12123113, ProvLang.UK);
	...
	public final void test1() {
		String s = converterService.convertIntToWord(1, ProvLang.UK);
		assertNotNull("null unexpected", s);
		assertEquals("one", s);
	}
	...
	public final void test15() {
		String s = converterService.convertIntToWord(15, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100() {
		String s = converterService.convertIntToWord(100, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test101() {
		String s = converterService.convertIntToWord(101, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test123() {
		String s = converterService.convertIntToWord(123, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test123456() {
		String s = converterService.convertIntToWord(123456, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1000000() {
		String s = converterService.convertIntToWord(1000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1000() {
		String s = converterService.convertIntToWord(1000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10099() {
		String s = converterService.convertIntToWord(10099, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10090() {
		String s = converterService.convertIntToWord(10090, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10001() {
		String s = converterService.convertIntToWord(10001, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000000() {
		String s = converterService.convertIntToWord(10000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000001() {
		String s = converterService.convertIntToWord(10000001, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100000() {
		String s = converterService.convertIntToWord(100000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100000000() {
		String s = converterService.convertIntToWord(100000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1100000() {
		String s = converterService.convertIntToWord(1100000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1123456() {
		String s = converterService.convertIntToWord(1123456, ProvLang.UK);
		assertNotNull("null unexpected", s);

...
public class TestInt2StrConverter {
	...
	public void testNonInt() {
		converterService.funcIntToString(Integer.MAX_VALUE + 1, ProvLang.UK);
	}

	@Test
	public void test12123113() {
		String s = converterService.funcIntToString(12123113, ProvLang.UK);
		assertEquals("twelve million one hundred and twenty three thousand one hundred and thirteen", s);
	}

	@Test
	public final void testZero() {
		String s = converterService.funcIntToString(0, ProvLang.UK);
	...
	public final void test1() {
		String s = converterService.funcIntToString(1, ProvLang.UK);
		assertNotNull("null unexpected", s);
		assertEquals("one", s);
	}
	...
	public void testIntMax() {
		String s = converterService.funcIntToString(Integer.MAX_VALUE, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test15() {
		String s = converterService.funcIntToString(15, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100() {
		String s = converterService.funcIntToString(100, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test101() {
		String s = converterService.funcIntToString(101, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test123() {
		String s = converterService.funcIntToString(123, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test123456() {
		String s = converterService.funcIntToString(123456, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1000000() {
		String s = converterService.funcIntToString(1000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1000() {
		String s = converterService.funcIntToString(1000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000() {
		String s = converterService.funcIntToString(10000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10099() {
		String s = converterService.funcIntToString(10099, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10090() {
		String s = converterService.funcIntToString(10090, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10001() {
		String s = converterService.funcIntToString(10001, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000000() {
		String s = converterService.funcIntToString(10000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test10000001() {
		String s = converterService.funcIntToString(10000001, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100000() {
		String s = converterService.funcIntToString(100000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test100000000() {
		String s = converterService.funcIntToString(100000000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1100000() {
		String s = converterService.funcIntToString(1100000, ProvLang.UK);
		assertNotNull("null unexpected", s);
	...
	public final void test1123456() {
		String s = converterService.funcIntToString(1123456, ProvLang.UK);
		assertNotNull("null unexpected", s);

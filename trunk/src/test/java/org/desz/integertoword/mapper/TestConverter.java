...
public class TestConverter {
	...
	public void testJavaStream() {
		 ...
		 */
		//
		String s = rsv.java8Function(Integer.MAX_VALUE);
		assertNotNull(s);
	...
	public final void test100() {
		String s = rsv.java8Function(100);
		assertNotNull(s);
	...
	public final void test101() {
		String s = rsv.java8Function(101);
		assertNotNull(s);
	...
	public final void test123() {
		String s = rsv.java8Function(123);
		assertNotNull(s);
		assertEquals("one hundred and twenty three", s);
	}
	...
	public final void test123456() {
		String s = rsv.java8Function(123456);
		assertNotNull(s);
	...
	public final void test1000000() {
		String s = rsv.java8Function(1000000);
		assertNotNull(s);
	...
	public final void test1000() {
		String s = rsv.java8Function(1000);
		assertNotNull(s);
	...
	public final void test10000() {
		String s = rsv.java8Function(10000);
		assertNotNull(s);
	...
	public final void test10099() {
		String s = rsv.java8Function(10099);
		assertNotNull(s);
	...
	public final void test10090() {
		String s = rsv.java8Function(10090);
		assertNotNull(s);
	...
	public final void test10001() {
		String s = rsv.java8Function(10001);
		assertNotNull(s);
	...
	public final void test10000000() {
		String s = rsv.java8Function(10000000);
		assertNotNull(s);
	...
	public final void test10000001() {
		String s = rsv.java8Function(10000001);
		assertNotNull(s);
	...
	public final void test100000() {
		String s = rsv.java8Function(100000);
		assertNotNull(s);
	...
	public final void test100000000() {
		String s = rsv.java8Function(100000000);
		assertNotNull(s);
	...
	public final void test1100000() {
		String s = rsv.java8Function(1100000);
		assertNotNull(s);
	...
	public final void test1123456() {
		String s = rsv.java8Function(1123456);
		assertNotNull(s);
